...
const ClaimSection = () => {
  return (
    <section className="relative flex flex-col items-center justify-center px-6 py-24 text-center md:px-10 lg:py-32 overflow-hidden border-t border-white/5">
      ...
      <div className="relative z-10 max-w-3xl mx-auto flex flex-col items-center gap-8">
        ...
        <div className="mt-4 flex flex-col items-center gap-3">
          <Button className="rounded-[0.8rem] px-10 py-7 text-lg font-bold bg-green-400 hover:bg-green-300 text-black transition-all shadow-[0_0_30px_rgba(74,222,128,0.2)] hover:shadow-[0_0_40px_rgba(74,222,128,0.4)] border-0">
            {CLAIM_SECTION_DATA.buttonText}
          </Button>
        </div>
      </div>
    </section>
